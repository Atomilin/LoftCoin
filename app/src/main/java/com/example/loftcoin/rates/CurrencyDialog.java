...
public class CurrencyDialog extends DialogFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RatesViewModel RatesViewModel = ViewModelProviders
                .of(requireParentFragment(), new RatesViewModel.Factory(getContext()))
                .get(RatesViewModel.class);

        dialogTitle = getView().findViewById(R.id.dialog_title);
        dialogTitle.setText(R.string.currency_chooser);
        ...
        itemUsd.setOnClickListener(view -> {
            RatesViewModel.setCurrency(DOLLAR);
            dialog.dismiss();
        });
        itemEur.setOnClickListener(view -> {
            RatesViewModel.setCurrency(EURO);
            dialog.dismiss();
        });
        itemRub.setOnClickListener(view -> {
            RatesViewModel.setCurrency(ROUBLE);
            dialog.dismiss();
        });
